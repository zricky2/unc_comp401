...
public class ImageEditorController implements ToolChoiceListener, MouseListener, MouseMotionListener {
	...
	public void mousePressed(MouseEvent e) {
		...
		//if (inspector_tool.getClicked()) {
		//	paint_brush_tool.setSliderChange();
		//	if (!paint_brush_tool.getSliderChange()) {
				((PaintBrushToolUI) paint_brush_tool.getUI()).setSlider((int) (inspector_tool.getRedSlider() * 100),
						(int) (inspector_tool.getGreenSlider() * 100), (int) (inspector_tool.getBlueSlider() * 100));
		//	}
	//	}
	}
